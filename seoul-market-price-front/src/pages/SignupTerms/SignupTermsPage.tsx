...
const TERMS: TermItem[] = [
  {
    ...
    title: "이용약관",
    content: `제1조 (목적)
이 약관은 싸농(이하 "회사")이 제공하는 농수산물 특가 정보 및 관련 서비스(이하 "서비스")의 이용조건 및 절차, 회사와 회원의 권리·의무 및 책임사항 등을 규정함을 목적으로 합니다.

제2조 (정의)
① "서비스"란 회사가 제공하는 주변 농수산물 판매처의 시세 및 특가 정보 제공, 회원 관리 등 일체의 서비스를 의미합니다.
...
제4조 (서비스의 제공 및 변경)
회사는 시세 정보, 위치 기반 특가 정보 등을 안정적으로 제공하기 위해 노력하며, 서비스의 내용은 운영상·기술상 필요에 따라 변경될 수 있습니다.
...
회사는 천재지변 등 불가항력적 사유로 서비스를 제공할 수 없는 경우 책임이 면제되며, 회원이 게재한 정보의 신뢰성에 대해서는 책임을 지지 않습니다.`,
  },
  {
    ...
    content: `1. 수집 목적
회원 식별 및 관리, 시세·특가 알림 등 맞춤 서비스 제공, 이벤트 및 혜택 정보 안내
...
이용자는 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다. 다만 선택 항목에 동의하지 않아도 서비스 이용에는 제한이 없으며, 관련 맞춤 혜택 안내가 제공되지 않을 수 있습니다.`,
  },
  {
    ...
    title: "위치기반서비스 이용약관",
    content: `제1조 (목적)
이 약관은 싸농이 제공하는 위치기반서비스와 관련하여 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

제2조 (서비스 내용)
회사는 회원의 위치정보를 이용하여 주변 농수산물 판매처의 특가 정보, 거리 기반 매장 안내 등의 서비스를 제공합니다.
