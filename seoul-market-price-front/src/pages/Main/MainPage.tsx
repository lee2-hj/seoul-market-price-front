...
function MainPage() {
  ...
  const filteredItems =
    category === "전체"
      ? popularItems
      : popularItems.filter((item) => item.category === category);
          ...
          <nav className={styles.nav}>
            ...
            <div className={styles.navDropdown}>
              ...
              <div className={styles.dropdownMenu}>
                <Link to="/price">간편가격정보</Link>

                <Link to="/price/detail">세부가격정보</Link>
              </div>
            </div>
            ...
            <div className={styles.navDropdown}>
              ...
              <div className={styles.dropdownMenu}>
                <Link to="/region-price">자치구별 가격비교</Link>

                <Link to="/region-price/my-area">우리 동네 가격</Link>
              </div>
            </div>
      ...
      <section className={styles.quickSection}>
        <div className={styles.quickMenu}>
          ...
          <Link to="/price/detail" className={styles.quickCard}>
            ...
            <div>
              <strong>세부가격정보</strong>
              <small>기간·지역별 상세 시세 조회</small>
            </div>
      ...
      <section className={styles.comparisonSection}>
        ...
        <div className={styles.comparisonGrid}>
          ...
          <div className={styles.referenceCard}>
            <div>
              <span>전일</span>
              <strong>{priceData.yesterday}원</strong>
              <em>+200원</em>
            </div>

            <div>
              <span>전월</span>
              <strong>{priceData.lastMonth}원</strong>
              <em>-1,220원</em>
            </div>

            <div>
              <span>전년</span>
              <strong>{priceData.lastYear}원</strong>
              <em>-550원</em>
            </div>

            <div>
              <span>평년</span>
              <strong>{priceData.average}원</strong>
              <em>-880원</em>
            </div>
          </div>
        </div>
