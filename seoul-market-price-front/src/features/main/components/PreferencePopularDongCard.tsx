      ...
      <CardHeader className="border-b border-[#E8EFF2] p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <CardTitle className="text-base font-black text-[#123047]">내 선호지역 인기지역</CardTitle>
      ...
      <CardContent className="p-4">
        {!item ? (
          ...
          <div className="flex min-h-[144px] flex-col justify-center">
            <span className="text-xs font-semibold text-[#6B7280]">{item.districtName}</span>
            <strong className="mt-1 break-words text-2xl font-black tracking-[-0.03em] text-[#123047] sm:text-3xl">
              {item.dongName}
            </strong>
            <p className="mb-0 mt-3 text-sm leading-6 text-[#526573]">최근 거래가 가장 활발한 지역입니다.</p>
          </div>
        )}
      </CardContent>
    </Card>
